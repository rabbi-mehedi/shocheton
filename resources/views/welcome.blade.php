    ...
    <div class="w-full bg-white shadow-sm">
        ...
        <main class="container mx-auto px-4 py-6">
            ...
            <div class="max-w-5xl mx-auto">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    ...
                    <a href="{{ route('forums.index') }}" 
                       class="bg-white hover:bg-gray-50 rounded-lg shadow-sm p-4 border border-gray-100 flex flex-col items-center justify-center transition duration-200">
                        ...
                        <span class="text-center font-semibold text-sm uppercase">{{ __('landing.community_forum_bn') }}<br>{{ __('landing.community_forum') }}</span>
                    </a>
                    ...
                    <a href="{{ route('heatmap') }}" 
                       class="bg-white hover:bg-gray-50 rounded-lg shadow-sm p-4 border border-gray-100 flex flex-col items-center justify-center transition duration-200">
                        ...
                        <span class="text-center font-semibold text-sm uppercase">{{ __('landing.offense_heatmap') }}</span>
                    </a>
                    ...
                    <a href="{{ route('map') }}" 
                       class="bg-white hover:bg-gray-50 rounded-lg shadow-sm p-4 border border-gray-100 flex flex-col items-center justify-center transition duration-200">
                        ...
                        <span class="text-center font-semibold text-sm uppercase">
                            @auth
                                {{ __('landing.emergency_alert') }}
                            @else
                                {{ __('landing.map_bn') }}<br>{{ __('landing.map') }}
                            @endauth
                        </span>
                    </a>
                    ...
                    <a href="{{ route('explain') }}" 
                       class="bg-white hover:bg-gray-50 rounded-lg shadow-sm p-4 border border-gray-100 flex flex-col items-center justify-center transition duration-200">
                        ...
                        <span class="text-center font-semibold text-sm uppercase">{{ __('landing.how_it_works_bn') }}<br>{{ __('landing.how_it_works') }}</span>
                    </a>
                </div>
                    ...
                    <div class="flex space-x-4">
                        <a href="{{ route('register') }}" 
                           class="bg-white hover:bg-red-50 border border-red-200 text-red-600 px-5 py-2 rounded-md font-semibold text-center transition duration-200 text-sm">
                            {{ __('landing.sign_up_bn') }} | {{ __('landing.sign_up') }}
                        </a>
                        <a href="{{ route('login') }}" 
                           class="bg-white hover:bg-gray-50 border border-gray-200 text-gray-700 px-5 py-2 rounded-md font-semibold text-center transition duration-200 text-sm">
                            {{ __('landing.login_bn') }} | {{ __('landing.login') }}
                        </a>
                    </div>
                </div>
                @endguest
                ...
                <div class="max-w-4xl mx-auto mb-10">
                    <div id="disclaimerToggle" 
                        ...
                        <span>{{ __('landing.disclaimer_note') }}</span>
                    </div>
                    ...
                    <div id="disclaimerContainer" 
                        ...
                        <div id="disclaimerBangla" class="block text-sm text-gray-600 space-y-2">
                            <ul class="list-disc pl-5">
                                <li>{{ __('landing.disclaimer_bn_1') }}</li>
                                <li>{{ __('landing.disclaimer_bn_2') }}</li>
                                <li>{{ __('landing.disclaimer_bn_3') }}</li>
                                <li>{{ __('landing.disclaimer_bn_4') }}
                                <br>{{ __('landing.disclaimer_bn_5') }}
                        ...
                        <div id="disclaimerEnglish" class="hidden text-sm text-gray-600 space-y-2">
                            <ul class="list-disc pl-5">
                                <li>{{ __('landing.disclaimer_en_1') }}</li>
                                <li>{{ __('landing.disclaimer_en_2') }}</li>
                                <li>{{ __('landing.disclaimer_en_3') }}</li>
                                <li>{{ __('landing.disclaimer_en_4') }}
                                <br>{{ __('landing.disclaimer_en_5') }}
                                <div class="flex space-x-6 mt-1">
                                    <a target="_blank" href="https://www.instagram.com/shocheton.live/" class="text-red-500 hover:underline">Instagram</a>
                                    <a target="_blank" href="https://www.facebook.com/profile.php?id=61573974269133" class="text-red-500 hover:underline">Facebook</a>
                                </div>
            ...
            <div class="max-w-6xl mx-auto">
                <h2 class="text-xl font-bold text-gray-800 mb-4 pb-2 border-b border-gray-200">{{ __('landing.recent_extortionists') }}</h2>
                    ...
                    @foreach ($extortionists as $extortionist)
                        <div class="bg-white shadow-sm p-4 rounded-lg">
                            ...
                            <p class="mt-2 text-xs text-gray-500">
                                {{ __('landing.reported_on') }} {{ $extortionist->created_at->format('M d, Y') }}
                            </p>
                        </div>
                    @endforeach
                </div>
